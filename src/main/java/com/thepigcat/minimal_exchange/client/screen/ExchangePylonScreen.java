...
public class ExchangePylonScreen extends MEAbstractContainerScreen<ExchangePylonMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float delta, int mouseX, int mouseY) {
        ...
        drawCenteredString(guiGraphics, Minecraft.getInstance().font, Component.literal(matter + "/" + matterCapacity + " Matter").withStyle(ChatFormatting.DARK_GRAY), this.width / 2, this.imageHeight / 2 - 7, 0, false);
    }
